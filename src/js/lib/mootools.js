/*
---
引入Mootools目的是用来弥补$在基于对象编程方面的不足

MooTools: the javascript framework

web build:
 - http://mootools.net/core/8b1325a2a16d08327af0116473944f66

packager build:
 - packager build Core/Core Core/Array Core/String Core/Number Core/Function Core/Object Core/Event Core/Class Core/Class.Extras
...
MooTools.More={version:"1.5.1",build:"2dd695ba957196ae4b0275a690765d6636a61ccd"};(function(){if(this.Hash){return;}var a=this.Hash=new Type("Hash",function(b){if(typeOf(b)=="hash"){b=Object.clone(b.getClean());
...
},toQueryString:function(b){return Object.toQueryString(this,b);}});a.alias({indexOf:"keyOf",contains:"hasValue"});})();
